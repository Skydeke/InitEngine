...
//        imgui.sliderFloat("float", f, 0, 0f, 1f, "%.3f", 1f);       // Edit 1 float using a slider from 0.0f to 1.0f
        ...
        // Rendering
        imgui.render();
        GL13.glViewport(window.getFramebufferSize().getX(),window.getFramebufferSize().getY(),
                1280, 720);
        GL13.glClearColor(clearColor.getX(), clearColor.getY(), clearColor.getZ(), clearColor.getZ());
