...
public class Shader {
  ...
  /**
   * Creates a shader of the given type, with the given file that contains the
   * code
   *
  ...
  public static Shader of(String fileName, ShaderType type) throws Exception {
    ...
    final String code = Utils.loadResource(fileName);
  ...
  /**
   * Creates a tessellation control shader with the given file that contains the
   * code
   *
   * @param fileName the code file
  ...
  /**
   * Creates a tessellation evaluation shader with the given file that contains
   * the code
   *
   * @param fileName the code file
  ...
  public void init() throws ShaderCompileException {
    ...
    if (GL20.glGetShaderi(id, GL20.GL_COMPILE_STATUS) == 0) {
      final String infoLog = GL20.glGetShaderInfoLog(id, 2048);
