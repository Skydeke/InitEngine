...
public class ViewportSettings {
    ...
    private final Color TOPBAR_COLOR_DEFAULT = new Color(0x1c2a5e);
    private final Color BORDER_COLOR_DEFAULT = new Color(0x1b2136);
    private final Color PANEL_COLOR_DEFAULT = new Color(0x151a2b);
