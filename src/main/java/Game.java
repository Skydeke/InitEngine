...
public class Game extends SimpleApplication {
    ...
    public void onInit(Window window, AppContext renderer) throws Exception {
        ...
        PBRModel m32 = new PBRModel(ModelGenerator.generateSphere(), new PBRMaterial("images/chipped_paint/", false));
        m32.getTransform().setPosition(0, 0, -20);
        m32.getTransform().setScale(2f);
        ...
        matTesters.addChildren(m1, m2, m3, m4, m5, m32);
    ...
    @Override
    public void onRender(AppContext renderer) {
        renderer.update();
        renderer.draw();
    }
